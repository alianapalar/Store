...
namespace Services
{
    public class AuthManager : IAuthService
    {
        ...
        public async Task<IdentityResult> CreateUser(UserInsertionForDTO userDto)
        {
        ...
        public async Task<UserUpdateForDTO> GetOneUserForUpdate(string userName)
        {
            var user = await GetOneUser(userName);
            var userDto = _mapper.Map<UserUpdateForDTO>(user);
        ...
        public async Task Update(UserUpdateForDTO userDto)
        {
